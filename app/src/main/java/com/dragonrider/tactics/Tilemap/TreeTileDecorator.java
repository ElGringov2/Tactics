...
/**
 * Created by dragonrider on 23/05/15.
 */
    ...
    public int DecorateUpperLayer(LayerMap TreeLayer, LayerMap UpperLayer) {
        ...
        for (int y = TreeLayer.getSize() - 1; y >= 0; y--)
            for (int x = 0; x < TreeLayer.getSize(); x++)
            {
                if (TreeLayer.getFirst(x, y) == -1) {
                    ...
                    if (x - 1 >= 0 && TreeLayer.getFirst(x - 1, y) != -1) {
                        ...
                        if (y + 3 < TreeLayer.getSize() - 1) {
                            UpperLayer.add(TreeLevelRightDecorationIDs[0], x, y + 3);
                            iCount++;
                        }
                        if (y + 2 < TreeLayer.getSize() - 1) {
                            UpperLayer.add(TreeLevelRightDecorationIDs[1], x, y + 2);
                            iCount++;
                        }
                        if (y + 1 < TreeLayer.getSize() - 1) {
                            UpperLayer.add(TreeLevelRightDecorationIDs[2], x, y + 1);
                            iCount++;
                        }
                        UpperLayer.add(RightShadowTileID, x, y);

                        UpperLayer.add(TreeLevelRightDecorationIDs[3], x, y);
                        iCount++;
                    }
                    if (x + 1 < TreeLayer.getSize() && TreeLayer.getFirst(x + 1, y) != -1) {

                        if (y + 3 < TreeLayer.getSize() - 1) {
                            UpperLayer.add(TreeLevelLeftDecorationIDs[0], x, y + 3);
                            iCount++;
                        }
                        if (y + 2 < TreeLayer.getSize() - 1) {
                            UpperLayer.add(TreeLevelLeftDecorationIDs[1], x, y + 2);
                            iCount++;
                        }
                        if (y + 1 < TreeLayer.getSize() - 1) {
                            UpperLayer.add(TreeLevelLeftDecorationIDs[2], x, y + 1);
                            iCount++;
                        }
                        UpperLayer.add(LeftShadowTileID, x, y);
                        UpperLayer.add(TreeLevelLeftDecorationIDs[3], x, y);
                        iCount++;
                    }
                ...
                if (y + 3 < TreeLayer.getSize() - 1) {
                    UpperLayer.add(TreeLevelIDs[0], x, y + 3);
                    iCount++;
                }
                if (y + 2 < TreeLayer.getSize() - 1) {
                    UpperLayer.add(TreeLevelIDs[1], x, y + 2);
                    iCount++;
                }
                if (y + 1 < TreeLayer.getSize() - 1) {
                    UpperLayer.add(TreeLevelIDs[2], x, y + 1);
                    iCount++;
                }
                UpperLayer.add(TreeLevelIDs[3], x, y);
                iCount++;
